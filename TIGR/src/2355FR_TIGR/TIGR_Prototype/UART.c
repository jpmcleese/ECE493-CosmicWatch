...
//  Modified for MSP430FR2355 port
...
//                      FR6989:           UCA1RXD=P3.5   UCA1TXD=P3.4
//                      FR2355:           UCA1RXD=P4.2   UCA1TXD=P4.3  ← CHANGED!
//
...
// Back channel UART = eUSCI Module 1 Channel A.
// FR2355: UCA1RXD=P4.2   UCA1TXD=P4.3
void UART1init(unsigned long BaudRate){
    //========================================================================
    // *** CHANGED FOR FR2355 ***
    // FR6989 used: P3SEL0 |=  (BIT5 | BIT4);  // P3.5=RX, P3.4=TX
    //              P3SEL1 &= ~(BIT5 | BIT4);
    //
    // FR2355 uses: P4.2=RX, P4.3=TX (same as UCA0 on FR6989)
    //========================================================================
    P4SEL0 |=  (BIT3 | BIT2);                 //Configure pin functions:
    P4SEL1 &= ~(BIT3 | BIT2);                 //UCA1RXD=P4.2   UCA1TXD=P4.3
